...
public class DateCards : MonoBehaviour {
    ...
    public void AddCardsToDeck() {
        ...
        gameController.AddCardToDeck(CardsManager.dateCards, "Date", 1, "Date Me B*tch", "Choose someone who will have the unfortunate opportunity of drinking everytime you drink through the remaining duration of the game");
